...
{
    /// <summary>
    ///     Implements the <see cref="IInputSimulator" /> interface to simulate Keyboard and Mouse input and provide the state of those
    ///     input devices.
    /// </summary>
    public class InputSimulator : IInputSimulator
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="InputSimulator" /> class using the specified <see cref="IKeyboardSimulator" />,
        ///     <see cref="IMouseSimulator" /> and <see cref="IInputDeviceStateAdaptor" /> instances.
        /// </summary>
        ...
        ///     The <see cref="IInputDeviceStateAdaptor" /> instance to use for interpreting the state of
        ///     input devices.
        /// </param>
        ...
        ///     <see cref="MouseSimulator" /> and <see cref="WindowsInputDeviceStateAdaptor" /> instances.
        /// </summary>
