...
namespace WindowsInput
{
    ...
    public interface IKeyboardSimulator
    {
        ...
        IKeyboardSimulator DelayedModifiedKeyStroke(IEnumerable<VirtualKeyCode> modifierKeyCodes,
        ...
        /// <param name="dikCode">The key to simulate</param>
        /// <param name="delay">Delay in ms between keydown and keyup of final keyCode.</param>
        IKeyboardSimulator DelayedModifiedKeyStroke(IEnumerable<DirectInputKeyCode> modifierDikCodes, DirectInputKeyCode dikCode,
            int delay);
        ...
        /// <param name="modifierDikCodes">The list of modifier keys</param>
        /// <param name="dikCodes">The list of keys to simulate</param>
        IKeyboardSimulator ModifiedKeyStroke(IEnumerable<DirectInputKeyCode> modifierDikCodes,
