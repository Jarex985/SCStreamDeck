...
namespace WindowsInput.Native
{
    ...
    public enum VirtualKeyCode //: UInt16
    {
        ...
        /// <summary>
        ///     Windows 2000/XP: Used to pass Unicode characters as if they were keystrokes. The PACKET key is the low word of a 32-bit
        ///     Virtual Key value used for non-keyboard input methods. For more information, see Remark in KEYBDINPUT, SendInput, WM_KEYDOWN,
        ///     and WM_KEYUP
        /// </summary>
        PACKET = 0xE7,
