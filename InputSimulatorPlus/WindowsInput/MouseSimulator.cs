...
{
    /// <summary>
    ///     Implements the <see cref="IMouseSimulator" /> interface by calling the an <see cref="IInputMessageDispatcher" /> to simulate
    ///     Mouse gestures.
    /// </summary>
    public class MouseSimulator : IMouseSimulator
    {
        ...
        /// <summary>
        ///     Gets or sets the amount of mouse wheel scrolling per click. The default value for this property is 120 and different values
        ...
        ///     The destination's absolute X-coordinate on the primary display device where 0 is the extreme left hand
        ///     side of the display device and 65535 is the extreme right hand side of the display device.
        /// </param>
        /// <param name="absoluteY">
        ///     The destination's absolute Y-coordinate on the primary display device where 0 is the top of the display
        ///     device and 65535 is the bottom of the display device.
        /// </param>
        public IMouseSimulator MoveMouseTo(double absoluteX, double absoluteY)
        {
            INPUT[] inputList = new InputBuilder()
        ...
        /// </summary>
        /// <param name="absoluteX">
        ///     The destination's absolute X-coordinate on the virtual desktop where 0 is the left hand side of the
        ///     virtual desktop and 65535 is the extreme right hand side of the virtual desktop.
        /// </param>
        /// <param name="absoluteY">
        ///     The destination's absolute Y-coordinate on the virtual desktop where 0 is the top of the virtual desktop
        ///     and 65535 is the bottom of the virtual desktop.
        /// </param>
        public IMouseSimulator MoveMouseToPositionOnVirtualDesktop(double absoluteX, double absoluteY)
        {
            INPUT[] inputList = new InputBuilder()
                .AddAbsoluteMouseMovementOnVirtualDesktop((int)Math.Truncate(absoluteX), (int)Math.Truncate(absoluteY)).ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
        ...
        ///     The amount to scroll in clicks. A positive value indicates that the wheel was rotated forward,
        ///     away from the user; a negative value indicates that the wheel was rotated backward, toward the user.
        /// </param>
        public IMouseSimulator VerticalScroll(int scrollAmountInClicks)
        {
            INPUT[] inputList = new InputBuilder().AddMouseVerticalWheelScroll(scrollAmountInClicks * MouseWheelClickSize)
                .ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
        ...
        /// </summary>
        /// <param name="scrollAmountInClicks">
        ///     The amount to scroll in clicks. A positive value indicates that the wheel was rotated to the
        ///     right; a negative value indicates that the wheel was rotated to the left.
        /// </param>
        public IMouseSimulator HorizontalScroll(int scrollAmountInClicks)
        {
            INPUT[] inputList = new InputBuilder().AddMouseHorizontalWheelScroll(scrollAmountInClicks * MouseWheelClickSize)
                .ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
